...
# Candidate source data (bar chart)
...
# Column 1: New Candidates per Origin (Bar Chart)
with col1:
...
# Column 2: Average Evaluation Score (Gauge-like visualization)
with col2:
...
# Row: Calendar Events and Emails Breakdown (Pie Charts)
st.markdown("---")
